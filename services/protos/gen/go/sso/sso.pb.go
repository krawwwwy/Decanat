...
const file_sso_sso_proto_rawDesc = "" +
	...
	"\n" +
	"is_student\x18\x01 \x01(\bR\tisStudent\"<\n" +
	"\rDeleteRequest\x12\x17\n" +
	"\auser_id\x18\x01 \x01(\x03R\x06userId\x12\x12\n" +
	"\x04role\x18\x02 \x01(\tR\x04role2\xfe\x03\n" +
	"\x04Auth\x12G\n" +
	...
	"\tIsStudent\x12\x16.auth.IsStudentRequest\x1a\x17.auth.IsStudentResponse\x129\n" +
	"\n" +
	"DeleteUser\x12\x13.auth.DeleteRequest\x1a\x16.google.protobuf.EmptyB\x15Z\x13krawwwwy.sso.v1;ssob\x06proto3"
...
var file_sso_sso_proto_depIdxs = []int32{
	...
	13, // 9: auth.Auth.DeleteUser:input_type -> auth.DeleteRequest
	4,  // 10: auth.Auth.RegisterStudent:output_type -> auth.RegisterResponse
	4,  // 11: auth.Auth.RegisterTeacher:output_type -> auth.RegisterResponse
	4,  // 12: auth.Auth.RegisterAdmin:output_type -> auth.RegisterResponse
	6,  // 13: auth.Auth.Login:output_type -> auth.LoginResponse
	10, // 14: auth.Auth.IsTeacher:output_type -> auth.IsTeacherResponse
	8,  // 15: auth.Auth.IsAdmin:output_type -> auth.IsAdminResponse
	12, // 16: auth.Auth.IsStudent:output_type -> auth.IsStudentResponse
	14, // 17: auth.Auth.DeleteUser:output_type -> google.protobuf.Empty
